  ...
  _createClass(Proxy, [{
    ...
    set: function set(url) {
      ...
      for (var _i4 = 0; _i4 < this.channelNum; _i4++) {
        var tmpChannel = urlArr[_i4];
        if (tmpChannel.type === 'jpg') {
          this.imageChannelId = _i4;
        } else {
          this['video' + (_i4 === 0 ? '' : _i4)].src = tmpChannel.files[this.currFileNumArr[_i4]].url;
        }
      }
...
var s_displayMode = function s_displayMode() {
  ...
  function canplayModeFunc() {
    ...
    var container = root.querySelector('.xgplayer-displaymode');
    if (!container) {
    ...
    var label = container.querySelector('.name');
    if (label) {
