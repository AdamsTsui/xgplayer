  ...
  _createClass(Player, [{
    ...
    value: function showCaption() {
      ...
      if (caption && caption.img) {
        _util2.default.addClass(root, 'xgplayer-caption-active');
        var captionCon = _util2.default.findDom(root, '.xgplayer-caption');
        var captionImg = _util2.default.findDom(root, '.xgplayer-caption-img');
        ...
        if (caption.pos) {
          switch (caption.pos) {
            case 1:
              _util2.default.addClass(captionCon, 'left-top');
              break;
            case 2:
              _util2.default.addClass(captionCon, 'right-top');
              break;
            case 3:
              _util2.default.addClass(captionCon, 'left-bottom');
              break;
            case 4:
              _util2.default.addClass(captionCon, 'right-bottom');
              break;
            default:
              _util2.default.addClass(captionCon, 'left-top');
          }
    ...
    value: function start() {
      ...
      if (_util2.default.typeOf(url) === 'String') {
        ...
        url.forEach(function (item) {
          _this3.video.appendChild(_util2.default.createDom('source', '', {
            src: '' + item.src,
            type: '' + (item.type || '')
          }));
        });
    ...
    container.addEventListener(item, function (e) {
      ...
      var up = function up(e) {
        ...
        if (!player.isProgressMoving || player.videoConfig.mediaType === 'audio' || player.dash || player.config.closeMoveSeek) {
          var _w = (isRotate ? e.clientY : e.clientX) - left;
          if (_w > containerWidth) {
            _w = containerWidth;
          }
          var _now = _w / containerWidth * player.duration;
          progress.style.width = _w * 100 / containerWidth + '%';
          player.currentTime = Number(_now).toFixed(1);
        }
        player.emit('focus');
...
var s_caption = function s_caption() {
  var player = this;
  var util = _player2.default.util;
  var container = util.createDom('xg-caption', '\n            <img class="xgplayer-caption-img"></img>\n            ', {}, 'xgplayer-caption');
  player.once('ready', function () {
    player.root.appendChild(container);
  });
};

_player2.default.install('s_caption', s_caption);
...
var VERSION = 'single-video-custom-v1.0.1';
